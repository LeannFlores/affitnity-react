...
const formSchema = z.object({
  email: z.string().min(1, { message: "Fill in username." }).max(50, { message: "Must not exceed beyond 50 characters." }),
      ...
      <div className="text-center text-2xl w-full mx-auto my-36 p-5 rounded-lg shadow-xl shadow-ash/20 mb-36 md:max-w-97">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            ...
            {/* login button */}
            <Button type="submit" className="font-dmsans w-full text-snow-white bg-brand hover:bg-amber-600 md:max-w-97">
              Login
            </Button>
          </form>
        ...
        <div className="grid grid-cols-1 mx-5 md:mx-17 md:grid-cols-2">
          ...
          <div className="md:order-first md:my-auto">
            ...
            <p className="font-dmsans text-[15px] mt-3 mb-5 md:text-lg md:w-xl md:mb-5">
              We're excited to be part of your transformation. Whether you're here to build strength, eat healthier, or simply feel better every day — we're here to guide you at every step.
              Let’s achieve your goals together with personalized support, proven strategies, and a community that has your back.
            </p>
            <Link
    ...
    <>
      <div className="mx-5 mt-40 md:mx-17">
        ...
        <div className="md:flex md:justify-between md:items-center">
          ...
          <Link to="/" className="px-5 py-3 text-[15px] mb-5 rounded-lg inline-flex items-center justify-center bg-moss-black font-dmsans text-snow-white hover:bg-gray-800">
            Start your plan
          </Link>
        </div>
        {/* grid section */}
        <div className="grid grid-cols-1 font-medium gap-4 md:grid-cols-3">
          <div className="group text-2xl bg-mygray text-moss-black py-8 px-5 rounded-lg hover:bg-moss-black">
            ...
            <p className="font-manrope text-sm font-normal mb-6 text-moss-black group-hover:text-brand">
              We believe fitness should be personal, which is why our workouts are tailored to your goals, body, and lifestyle. Personalized training helps you achieve better results, stay
              motivated, and avoid injuries. With a custom plan, you’re set for lasting success and your best self.
            </p>
            <div className="flex items-center gap-3">
              <Link to="/" className="font-manrope text-sm font-medium group-hover:text-brand">
                Read More
              </Link>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 group-hover:text-brand">
          ...
          <div className="group text-2xl bg-mygray text-moss-black py-8 px-3 rounded-lg hover:bg-moss-black">
            ...
            <p className="font-manrope text-sm font-normal mb-6 text-moss-black group-hover:text-brand">
              We believe fitness should be as unique as you are. Our AI-powered workouts are tailored to your goals, body, and lifestyle, helping you train smarter and achieve real results.
              With personalized guidance, you’ll stay motivated, reduce the risk of injury, and unlock lasting success.
            </p>
            <div className="flex items-center gap-3">
              <Link to="/" className="font-manrope text-sm font-medium group-hover:text-brand">
                Read More
              </Link>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 group-hover:text-brand">
          ...
          <div className="group text-2xl bg-mygray text-moss-black py-8 px-3 rounded-lg hover:bg-moss-black">
            ...
            <p className="font-manrope text-sm font-normal mb-6 text-moss-black group-hover:text-brand">
              We believe nutrition should adapt to you, not the other way around. Our adaptive meal guides are tailored to your health goals, preferences, and lifestyle, making healthy
              eating simple and sustainable. With personalized guidance, you can fuel your body smarter and stay on track toward lasting wellness.
            </p>
